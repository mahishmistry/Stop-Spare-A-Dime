import { add_user, get_user_by_email, add_store, add_store_location, add_product, get_product_by_id, add_item, add_deal, get_deal_by_id, } from '../queries.ts';
from;
'../queries.js';
describe('database query input validation', () => {
    ...
    it('rejects blank address fields', async () => {
        await expect(add_store_location('store', {
            street: '',
            city: 'Amherst',
            state: 'MA',
            zip_code: '01002',
...
//# sourceMappingURL=queries_validation.test.js.map